...
# Critères d'entrée (OPTIMISÉS POUR PLUS D'ACTIVITÉ)
VOLATILITY_THRESHOLD = 40          # Percentile de volatilité minimum (40% = plus d'opportunités)
MIN_SIGNAL_QUALITY = 0.65          # Qualité minimum du signal (65% = moins sélectif)
MIN_VOLUME_RATIO = 1.0              # Ratio volume minimum vs moyenne (assoupli)
MAX_PRICE_RANGE = 0.08              # Range de prix maximum pour consolidation (assoupli)
...
CURRENT_PROFILE = 'AGGRESSIVE'  # Changé pour plus d'activité
